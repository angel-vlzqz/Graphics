...
//This is the number of trails that will get rendered to the screen
const int NUM_TRAILS = 15;
//This is the length of the trails
...
void init() {
    ...
    for (int i = 0; i < NUM_TRAILS; i++) {
        ...
        for (int j = 0; j < TRAIL_LENGTH; j++) {
            Point p = {0, 0, 0, 
                      0.5f + 0.5f * (float)sin(i * 2.1f),
                      0.5f + 0.5f * (float)sin(i * 3.2f),
                      0.5f + 0.5f * (float)sin(i * 4.3f)};
...
//This draws the Light Trail Scene
void display() {
...
//This is incharge of updating the scene by calling update on each trail
...
//this is the main function that initializes OpenGL and the scene
